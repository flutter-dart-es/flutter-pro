...
import 'package:flutteruberfood/src/ui/restaurants_page.dart';
...
class LoginPage extends StatelessWidget {
  ...
  void _openRestaurantsPage(BuildContext context) {
    Navigator
    .of(context)
        .push(MaterialPageRoute(builder: (BuildContext context) {
        return BlocProvider<RestaurantesBloc>(
          child:  RestaurantsPage(),
          bloc: RestaurantesBloc(),
        );
    }));
  }
}
